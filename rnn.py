...
if __name__ == "__main__":
    ...
    word_embedding = pickle.load(
        open('/content/drive/MyDrive/NLP Assignment 2/Data_Embedding/word_embedding.pkl', 'rb'))
    ...
    string = '/content/drive/MyDrive/NLP Assignment 2/results/RNN - HiddenLayerDim - ' + \
